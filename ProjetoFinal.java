...
public class ProjetoFinal {
    public static void main(String[] args) {
        ...
        // 0 = Arroz, 1 = Feijão, 2 = Açúcar, 3 = Café, 4 = Macarrão
        ...
        do {
            ...
            switch (opcao.strip()) {
                case "1": // catalogo
                    catalogo(produtos, quantidade, valor); // MÓDULO
                    break;

                case "2": // compra
                    compra(quantidade, input, carrinho, valor, contador); // MÓDULO
                    break;

                case "3": // exibir carrinho
                    System.out.println("===============================================================");
                ...
                case "4": // editar compra
                    editar(quantidade, carrinho, input, contador); // MÓDULO
                    break;

                case "5": // finalizar compra
                    finalizarCompra(produtos, valor, carrinho, input, finalizador); // MÓDULO
                    if (finalizador[0] == 1) {
                        finalizar = true;
                    }
                    break;
    ...
    public static void catalogo(String produtos[], int quantidade[], double valor[]) {
        //Exibe os produtos, valores e a quantidade
        System.out.println("===============================================================");
    ...
    public static void compra(int quantidade[], Scanner input, int carrinho[], double valor[], int contador[]) {
        ...
        do {
            ...
            // ID's: 1 = Arroz, 2 = Feijão, 3 = Açúcar, 4 = Café, 5 = Macarrão
    ...
    public static void finalizarCompra(String produtos[], double valor[], int carrinho[], Scanner input, int finalizador[]) {
        ...
        System.out.println("1 - O cliente NÃO possui cupom de desconto");
        System.out.println("===============================================================");
